...
create table personalhierarchie(
	...
	vorgesetzterid integer,
		constraint vorgesetzteridFK 
			foreign key (vorgesetzterid) 
				references personalhierarchie(mitarbeiterid)
);
...
create table ausbilder_alt(
	...
	CONSTRAINT idauszubildender_FK 
		FOREIGN KEY (idauszubildender) 
			REFERENCES auszubildender_alt (id)
);
...
create table mengea(
	elementid smallint primary key,
	element smallint
);
...
create table arbeitszeit(
	arbeitszeitid serial primary key,
	arbeitstag date,
	jahr integer,
	monat integer,
	tag integer,
...
create table produktgleich(
	...
	marktbewertung smallint

);



/*Tabellen Kapitel xxx*/
...
CREATE TABLE premiumkunde (
  ...
  firma VARCHAR(120) NULL,
  gewerblich SMALLINT NULL,
  premiumstatus SMALLINT NULL,
  PRIMARY KEY (kundeid));		
...
insert into mitarbeiter (mitarbeiterid,name,vorname,gebdatum,eintrittsdatum,austrittsdatum,austrittsgrund,strasse,hausnummer,ort,plz,festnetz,mobilnetz,email,umsatz,bonus,geschlecht,abteilung,krankenversicherung,verheiratet,anzahlkinder,stundenlohn,ueberstunden,stundenpromonat,urlaubstage,urlaubgenommen,steuerklasse,bankinstitut,bankleitzahl,kontonummer,monatslohn)
values (20,'Klein','Bärbel','1967.07.18','1996.06.19',null,null,'Challengerstraße','987','Nelkendorf',90000,'4567/3333333333','8901/555555555555','baerbelklein@gansserver.appetit',234000.00,1200.00,'w','Vertrieb','Barmer GEK','nein',0,50.00,3,180,30,27,'1','Stadtsparkasse Köln',37050198,0000000000,7000.00);

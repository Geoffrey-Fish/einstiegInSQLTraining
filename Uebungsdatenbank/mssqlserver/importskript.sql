...
/*Lege Tabelle kunde_intern_d an */
...
create table arbeitszeit(
	arbeitszeitid integer IDENTITY (1,1) primary key,
	arbeitstag date,
	kommen time,
	jahr integer,
	monat integer,
...
CREATE TABLE dsgvo (
 ...
 create table gesundbleiben(
	id_aktivitaet integer primary key,
	aktivitaet varchar(200),
...
/* Füge Daten in Tabelle anforderung_intern_neu ein */
...
insert into niederlassungholland values (7,'Klugfeld','Andreas','inaktiv');
...
insert into niederlassungbelgien values (7,'Klugfeld','Andreas','aktiv');
...
insert into niederlassungschweiz values (8,'Klugfeld','Andreas','aktiv');
...
insert into bonus (bonusid,bonuszahlung,mitarbeiterid,auszahlungsdatum)
values(63,10000,NULL,'2013.02.01');

insert into bonus (bonusid,bonuszahlung,mitarbeiterid,auszahlungsdatum)
values(64,5000,NULL,'2013.02.01');

insert into bonus (bonusid,bonuszahlung,mitarbeiterid,auszahlungsdatum)
values(65,20000,NULL,'2013.02.01');

insert into bonus (bonusid,bonuszahlung,mitarbeiterid,auszahlungsdatum)
values(66,25000,NULL,'2013.02.01');

insert into bonus (bonusid,bonuszahlung,mitarbeiterid,auszahlungsdatum)
values(67,18000,NULL,'2013.02.01');
...
insert into umsatz (quartal,umsatz) values(2,7999999.50);
insert into umsatz (quartal,umsatz) values(3,8756825.83);
insert into umsatz (quartal,umsatz) values(4,11786951.78);
...
/* Füge Daten in Tabelle artikelarchiv ein */
...
insert into mitarbeiterdoppelt (name,vorname,strasse,hausnummer,ort,plz)
values ('Eisenhof','Frank','Columbiastraße','56','Meerrettichvillage',40000);
...
/* Füge Daten in Tabelle kreditinstitut ein */

insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (1,10000000,'Bundesbank',10591,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (2,10010010,'Postbank',10916,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (3,10010111,'SEB',10789,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (4,10010222,'The Royal Bank of Scotland, Niederlassung Deutschland',10105,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (5,10010424,'Aareal Bank',10666,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (6,10019610,'Dexia Kommunalbank Deutschland',10969,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (7,10020000,'Berliner Bank -alt-',10890,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (8,10020200,'BHF-BANK',10117,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (9,10020400,'Citadele Bank Zndl Deutschland',80331,'München');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (10,10020500,'Bank für Sozialwirtschaft',10178,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (11,10020890,'UniCredit Bank - HypoVereinsbank',10896,'Berlin');
insert into kreditinstitut (bankid,bankleitzahl,bezeichnung,plz,ort) values (12,10020890,'UniCredit Bank - HypoVereinsbank',14532,'Kleinmachnow');




/* Insert Anweisungen für Kapitel xxx ALTER TABLE*/
...
insert into infokunde values(3,'Nicht so guter Kunde!','Schrauben Klein GmbH','Nicht so guter Kunde!',1);
  ...
  INSERT INTO dsgvo values(1,NULL,'Schrauben Meier GmbH');
  INSERT INTO dsgvo values(2,NULL,'Schrauben Peter GmbH');
  INSERT INTO dsgvo values(3,NULL,'Schrauben Klein GmbH');
...
insert into gesundbleiben values (1,'Gemüse essen','Ernährung');
insert into gesundbleiben values (2,'Obst essen','Ernährung');
insert into gesundbleiben values (3,'Balaststoffe zu sich nehmen','Ernährung');
insert into gesundbleiben values (4,'Laufen','Bewegung');
insert into gesundbleiben values (5,'Nordic Walking','Bewegung');
insert into gesundbleiben values (6,'Rückenschule','Bewegung');